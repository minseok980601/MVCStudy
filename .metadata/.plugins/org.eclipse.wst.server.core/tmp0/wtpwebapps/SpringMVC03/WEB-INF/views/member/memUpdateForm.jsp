    	...
    	<form name="frm" action="${contextPath}/memUpdate.do" method="post">
    		...
    		<table class="table table-bordered" style="text-align: center; border: 1px solid #dddddd;">
    			...
    			<tr>
    				...
    				<!-- onkeyup - 키보드를 눌렀다가 땠을때 패스워드 두개가 같은지 다른지를 체크 -->
    			...
    			<tr>
    				...
    				<td colspan="2"><input id="memEmail" name="memEmail" class="form-control" type="text" maxlength="20" placeholder="이메일을 확인하세요." value="${mvo.memEmail }"/></td>
    			</tr>
    			<tr>
